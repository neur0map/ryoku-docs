...
<AccordionGroup>
  ...
  <Accordion title="How do I update Ryoku?">
    ...
    run from **Ryoku Settings > Updates** or the update island in the bar. See
  ...
  <Accordion title="How do I change the theme or wallpaper?">
    ...
    wallpapers, press `Mod + W` to open the wallpaper and theme menu (Ryowalls
    browses wallhaven from there), or `Mod + Shift + W` to cycle a random one. By
    default the color palette follows the wallpaper (via matugen); some themes
